...
# ~/QEMU/RUN/right.sh
# runs the l-variant FreeBSD virtual machine
...
qemu-system-x86_64 -monitor none \
    ...
    -drive if=none,id=drive0,cache=writeback,aio=threads,format=qcow2,discard=unmap,file=/home/kj/QEMU/VM/left.qcow2 \
